/*
rule = StatusRuntimeExceptionForBusinessError
 */
...
case class InvalidServiceIdsProvided(serviceIds: Seq[String])
    extends StatusRuntimeException( /* assert: StatusRuntimeExceptionForBusinessError.business-error-uses-system-exception*/
