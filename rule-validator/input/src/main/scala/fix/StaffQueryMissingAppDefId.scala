/*
rule = StaffQueryMissingAppDefId
*/
...
object StaffQueryMissingAppDefIdInput {
  ...
  class Client(
    ...
    def all(): Future[Seq[String]] =
      staffMembersAdapter.getAllStaffMembers() /* assert: StaffQueryMissingAppDefId.staff-query-missing-appdefid*/

    // BAD: query verb, no scoping arg
    def queryAll(): Future[Seq[String]] =
      staffMembersAdapter.queryAllStaffMembers() /* assert: StaffQueryMissingAppDefId.staff-query-missing-appdefid*/

    // BAD: list verb with non-appDefId positional arg
    def listActive(): Future[Seq[String]] =
      staffMembersAdapter.listActiveStaffMembers("active") /* assert: StaffQueryMissingAppDefId.staff-query-missing-appdefid*/
